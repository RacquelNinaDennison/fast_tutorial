...
test(`fix #8`, () => {
  ...
  const createProductSchema = _zod.z.object({ ...productInput
  });

  const productResponseSchema = _zod.z.object({ ...productInput,
    ...productGenerated
  });
  ...
  const createUserSchema = _zod.z.object({ ...userCoreSchema,
  ...
  const createUserResponseSchema = _zod.z.object({ ...userCoreSchema,
    id: _zod.z.number()
  });
